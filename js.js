window.onload = function(){
    ...
    document.getElementById("pwhite_scoore").innerHTML=Math.max(cou(values)[0]-cou(values)[1],0);
    document.getElementById("pblack_scoore").innerHTML=Math.max(cou(values)[1]-cou(values)[0],0);
